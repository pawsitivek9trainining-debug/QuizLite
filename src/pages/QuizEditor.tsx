...
function QuizEditor() {
  const [title, setTitle] = useState('Math Quiz 1');
  const [description, setDescription] = useState('A comprehensive quiz covering basic algebra concepts');
  const [classroom, setClassroom] = useState('algebra-101');
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-slate-100">
      <div className="max-w-3xl mx-auto py-12 px-4 space-y-8">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Last saved at 12:30pm</p>
        </div>
